    ...
    public function charging($info)
    {
        ...
        if (!empty($response)) {
            ...
            if (!empty($response['status'])) {
                ...
                echo 'Tham số truyền về không đúng định dạng. Mời bạn liên hệ với nhà cung cấp dịch vụ để biết thêm chi tiết';
                die;
            }
        } else {
            echo 'Gạch thẻ không thành công. Mời bạn kiểm tra lại đường truyền và bật các extendsion cần thiết.';
            die;
        }
